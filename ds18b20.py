...
class DS18B20:
    ...
    def __init__(self):
        ...
        """ I added this to get the name of sensors"""
        self._device_file_for_name = list()
        i = 0
        while i < self._num_devices:
            self._device_file_for_name.append(device_folder[i] + '/name')
            i += 1
    ...
    def read_name(self, index):
        f = open(self._device_file_for_name[index], 'r')
        lines = f.readlines()
        f.close()
        return lines[0][:-1]
